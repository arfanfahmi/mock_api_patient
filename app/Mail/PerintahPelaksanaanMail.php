...
class PerintahPelaksanaanMail extends Mailable
{
    ...
    {
        try {
            return $this->markdown('email.perintah_pelaksanaan_email')
                        ->with([
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: 'Perintah pelaksanaan #'.$noRealisasi.' '.$this->unit->nama_unit,
        );
    }
